...
public class StudentSession implements UserSession {
    ...
    private void registration() {
        List<String> coursesId = REG.get(student);
        List<Course> courses = DB.getCourseById(coursesId);
    ...
    private void activeCourses() {
        List<Course> courses = DB.getActiveStudentCourses(student);
    ...
    @Level(4)
    private void marks() {
        Marks marks = currentCourse.getMarks(student.getLogin() );
